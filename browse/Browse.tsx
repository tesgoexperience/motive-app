    ...
    render() {
        ...
        return <ScrollView refreshControl={<RefreshControl refreshing={this.state.refreshingViaPulldown} onRefresh={() => {
            ...
            <View style={{ width: '100%', flexDirection: "row", justifyContent: 'space-between' }}>
                <TouchableOpacity onPress={()=>this.changeView(VIEW.ALL)} style={{ width: '30%', borderWidth: 1, borderColor: '#69FFAA', borderRadius: 5, padding: 8 }}><Text style={{ textAlign: 'center' }}>All<Text style={{ color: 'red', fontWeight: 'bold' }}> • {this.state.stats?.all}</Text></Text></TouchableOpacity>
                <TouchableOpacity onPress={()=>this.changeView(VIEW.ATTENDING)} style={{ width: '30%', borderWidth: 1, borderColor: '#E2E2E2', borderRadius: 5, padding: 8 }}><Text style={{ textAlign: 'center' }}>Attending<Text style={{ color: 'red', fontWeight: 'bold' }}> • {this.state.stats?.attending}</Text></Text></TouchableOpacity>
                <TouchableOpacity style={{ width: '30%', borderWidth: 1, borderColor: '#69FFAA', borderRadius: 5, padding: 8 }}><Text style={{ textAlign: 'center' }}>Finished<Text style={{ color: 'red', fontWeight: 'bold' }}> • 13</Text></Text></TouchableOpacity>
            </View>
            {motives}
        </ScrollView>
    }
